...
public class googlepay extends AppCompatActivity {
    ...
    Button send;
    String TAG ="main";
    String upi="rjrshree1@okhdfcbank";
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // }else if (TextUtils.isEmpty(upivirtualid.getText().toString().trim())){
                 //   Toast.makeText(googlepay.this," UPI ID is invalid", Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(note.getText().toString().trim())){
                    Toast.makeText(googlepay.this," Note is invalid", Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(amount.getText().toString().trim())){
                    Toast.makeText(googlepay.this," Amount is invalid", Toast.LENGTH_SHORT).show();
                }else{

                    payUsingUpi(name.getText().toString(), upi,
