...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
            db.execSQL("Create table user(username text primary key, password text,Collegename text, branch text)");
    }
    ...
    public boolean insert(String username, String password, String Collegename, String branch){
